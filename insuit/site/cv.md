...
Full-stack developer in Prague. Kotlin, Java, PHP, PostgreSQL, React, Terraform
...
The work covered analysing the existing software, defining requirements with the
...
![The Trisbee app's transactions screen next to the slogan: punk might not be dead but cash is](/assets/cv/trisbee-transactions.jpg "The relaunched pivot to a web app, a PWA")
![Three Trisbee screens: entering 200 CZK with a tip, choosing Apple Pay, and the payment sent confirmation](/assets/cv/trisbee-payment-flow.jpg "The relaunched web app for customers paying merchants, with several payment methods and tips at venues that turned them on")
![The Trisbee pricing page: Start, Plus and Premium plans for accepting card payments](/assets/cv/trisbee-pricing.png)
![The Trisbee payment link page: all payment details wrapped in one link](/assets/cv/trisbee-payment-link.webp)
...
[EU FinTech Map](https://digital-finance-platform.ec.europa.eu/observatory/eu-fintech-map/trisbee#overview)
...
module development, frontend implementation, and content migration from the
legacy platform.

The relaunch also meant coordinating with the operations team to move the
company's SVN and legacy Git repositories and its Jenkins setup to a self-hosted
GitLab instance. To support the project, I initiated an internal Redmine for
...
![The Dny Marianne app: the discount code, with and without a Mastercard card](/assets/cv/dny-marianne-code.webp)
...
the Czech Spalding and Uhlsport shops.
